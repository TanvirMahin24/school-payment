...
const BatchBreakdown = ({
  ...
  const hasData = Array.isArray(batchBreakdown) && batchBreakdown.length > 0;
  ...
  return (
    <div>
      ...
      <ReportExportActions
        ...
        fileName={`Batch-Breakdown-${startMonth}-${startYear}-${endMonth}-${endYear}`}
        hasData={hasData}
      />
      ...
      {loading ? (
        ...
        <div ref={componentRef}>
          <Card className="border-0">
            <Card.Body>
              <ReportPrintHeader
                title="Batch-wise Payment Breakdown"
                subtitle={subtitle}
                tenant={selectedTenant}
              />
