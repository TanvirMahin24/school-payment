...
const ShiftBreakdown = ({ selectedTenant, shiftBreakdown, getShiftBreakdown, loading }) => {
  ...
  const totalPayment = useMemo(() => {
    if (!shiftBreakdown || shiftBreakdown === null || shiftBreakdown.length === 0) return { payment: 0, extraPayment: 0 };
...
const mapStateToProps = (state) => ({
  shiftBreakdown: state.report?.shiftBreakdown,
